...
import GlobeVisualization from "@/components/containers/home/globe/GlobeVisualization";
const HomeBanner = () => {
  useEffect(() => {
          ...
          <div className="col-12 col-sm-8 col-md-7 col-lg-7 col-xxl-6">
            <div className="banner__content text-center">
              <h1 className="title-animation">
                <span>Innovate, Integrate, Ignite</span>with{" "}
                <span className="banner-anime"> Conomis </span>
              </h1>
            </div>
          </div>
        </div>
