...
import ThumbOne from "public/images/footer/1.jpeg";
import ThumbTwo from "public/images/footer/2.jpeg";
                ...
                <div className="col-12 col-lg-4">
                  <div className="footer__nav-logo text-center text-lg-start">
                    <Link href="/" aria-label="home page" title="logo">
                      <Image src={Logo} style={{width:"200px"}} alt="Image" priority />
                    </Link>
                  </div>
                </div>
                ...
                <div className="col-12 col-lg-6">
                  <div className="footer__copyright-content text-center text-lg-start">
                    <p>
                      ...
                      <Link href="/">Conomis</Link>. All Rights Reserved
                    </p>
                  </div>
                </div>
                <div className="col-12 col-lg-6">
